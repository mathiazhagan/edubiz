...
<div style="width:1100px; height:300px; font-family:CRYSTALCORE; color:#000;text-align:justify; background-image:url(file:///H|/edubiz/src/main/webapp/images/blue_water_splash_world_map_shutterstock.jpg);"><p style="font-size:30px; padding-left:390px; padding-top:30px;"><strong>Join With Us</strong></p>
...
<a id="various1" href="#inline1" title="Lorem ipsum dolor sit amet" style="padding-left:350px;"><img src="" height="75px" width="300px" /></a>
<div style="display: none;" >
		<div id="inline1" style="width:700px;height:450px;overflow:auto; padding-left:35px; background:url(file:///H|/edubiz/src/main/webapp/images/090100084.jpg) " align="center" >
