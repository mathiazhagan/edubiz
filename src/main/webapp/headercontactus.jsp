<%-- 
    Document   : headercontactus
    Created on : Jan 7, 2012, 3:24:08 PM
...
<html>
 ...
 <script src="scripts/colorbox1.js"></script>
<style type="text/css">
body {
	margin: 0;
	padding: 0;
...
a
{
	...
	color:#000;
                ...
                <link href="css/cascadinstyle.css" rel="stylesheet"  type="text/css" media="screen"/>
